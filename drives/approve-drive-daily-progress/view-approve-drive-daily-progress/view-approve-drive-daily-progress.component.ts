...
@Component({
    selector: 'view-approve-drive-daily-progress-dialog',
    templateUrl: './view-approve-drive-daily-progress.component.html',
})
export class ViewApproveDriveDailyProgressComponent implements OnInit {
    ...
    constructor(@Inject(MAT_DIALOG_DATA) private data,
                ...
                public dialogRef: MatDialogRef<ViewApproveDriveDailyProgressComponent>) {
        if (data) {
            this.response = data;
        }
    }
